...
region_packs: typing.Dict[str, RegionsData] = {
    ...
    "open": RegionsData(
        ...
        region_connections = [
            ...
            RegionConnection(region_from='open5', region_to='openCursedTemple', cond=[ItemCondition(item_name='Heat', amount=1), ItemCondition(item_name='Cold', amount=1), ItemCondition(item_name='Cursed Coin', amount=1)]),
